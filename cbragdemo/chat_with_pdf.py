...
def main():
    ...
    if st.session_state.auth:
        ...
        CB_HOSTNAME = options.host
        CB_USERNAME = options.user
        CB_PASSWORD = options.password
        CB_BUCKET = options.bucket
        CB_SCOPE = options.scope
        CB_COLLECTION = options.collection
        CB_SEARCHINDEX = options.index
